...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/*
	 * @ExceptionHandler(ConflictException.class) protected ResponseEntity<Object>
	 * handleConflict(ConflictException ex) { return buildResponseEntity(new
	 * ApiError(HttpStatus.CONFLICT, ex.getMessage())); }
	 */
}